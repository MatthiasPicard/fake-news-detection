...
if __name__ == "__main__":
    ...
    nb_event_csv = 1   # 1 = 15 min of data
    nb_mentions_csv = 1
    ...
    name_save = "35_source_35_event_ismixte_False_connexions_article_Actor1Namen_remove"
    name_load = "35_source_35_event_ismixte_False_connexions_article_Actor1Name_remove"
