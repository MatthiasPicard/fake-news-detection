...
class GraphViz():
    def __init__(self,label,list_event,list_mention):
        ...
        self.data_undirected,self.edge_same_event,self.df_article_sorted,self.labels_sorted,self.df_events_sorted_temp,self.edge_mentionné,self.edge_est_source_de,self.y = self._retrieve_data_for_viz()
